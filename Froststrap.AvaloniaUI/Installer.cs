...
namespace Froststrap
{
    internal class Installer
    {
        ...
        public string FroststrapInstallDirectory = Path.Combine(Paths.LocalAppData, "Froststrap"); // default directory for Froststrap
        ...
        public void DoInstall()
        {
            ...
            // only register player, for the scenario where the user installs Froststrap, closes it,
        ...
        private bool ValidateLocation()
        {
            ...
            if (InstallLocation.Contains("Local\\Froststrap"))
                return false;
