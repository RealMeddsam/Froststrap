...
{
    internal static class AmdCpuOptimization
    {
        public static bool ToggleAmdOptimizations(bool enable)
        {
            if (!IsRunningAsAdmin())
            {
            ...
            try
            {
                ...
                {
                    DisableAmdOptimizations();
                }

                Frontend.ShowMessageBox(
                    $"AMD CPU optimizations {(enable ? "enabled" : "disabled")} successfully.",
            ...
            {
                Frontend.ShowMessageBox(
                    $"Failed to {(enable ? "enable" : "disable")} AMD CPU optimizations:\n\n{ex.Message}",
        ...
        private static void EnableAmdOptimizations()
        {
        ...
        private static void DisableAmdOptimizations()
        {
        ...
        public static bool IsAmdOptimizationEnabled()
        {
            try
            {
                int enabledCount = 0;
            ...
            {
                Debug.WriteLine($"Error checking AMD optimization state: {ex.Message}");
                return false;
            }
        }
